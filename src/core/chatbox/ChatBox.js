...
const data = [
  {
    message: "Hi Joseph, I am your virtual assistant. How can I help you today?",
    image: clientVa,
    isClient: false
  },
  {
  ...
  return (
    <div className={styles.chatMain}>
      {value.map((value, index) => (
        <div className={value.isClient ? styles.chatMain__right : styles.chatMain__left}>
          <img src={value.image} />
      ...
      <span>
        {toggle == true ?  <img onClick={() => setToggle(false)}  src={close} alt="close" /> :  <img onClick={() => setToggle(true)}  src={vaAdd} alt="add" />}
        {/* <img onClick={() => setToggle(true)}  src={vaAdd} alt="add" /> */}
        <img  src={microphone} alt="microphone" />
      </span>
    
        <img onClick={handleSend} style={{marginTop: "30px", position: "absolute"}} src={send} alt="send"/>
