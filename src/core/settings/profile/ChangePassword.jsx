                        ...
                        <form className="form" onSubmit={handleDelete}>
                            ...
                            <div className="form-form">
                                <div className="form-field">
                                    ...
                                    <input type="text" id="FullName" name="Current_password" value={Current_password} onChange={onChange} />
                                </div>
                                <div className="form-field">
                                    <label htmlFor="Email">Enter new password</label>
                                    <input type="text" id="Email" name="New_password" value={New_password} onChange={onChange} />
                                </div>
                                <div className="form-field">
                                    <label htmlFor="phone">Confirm new password</label>
                                    <input type="text" id="phone" name="Confirm_password" value={Confirm_password} onChange={onChange} />
                                </div>
                            </div>
