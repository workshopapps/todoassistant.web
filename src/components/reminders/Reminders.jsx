...
const remindersListRender = reminders.map((reminder)=>
 <Reminder key={reminder.id} header={reminder.header} optionType={reminder.optionType} headerType={reminder.headerType} showSave={reminder.showSave} list={reminder.list}/>)
  return (
<div>
 {remindersListRender}
</div>
