      ...
      <form className={contactStyles.formContainer} onSubmit={handleSubmit}>
          <div>
            <label className={contactStyles.contactFormLabel}>
             ...
             className={contactStyles.contactFormInput}  value={email} onChange={(e)=> setEmail(e.target.value)}/>
          </div>
          
          <div>
            <label
            className={contactStyles.contactFormLabel}>
              Phone Number{" "}
            </label>
              <input
                required
...
value={message} onChange={(e)=> setMessage(e.target.value)}/>
          ...
          <button type="submit" className={contactStyles.buttom}>
            Submit Message
          </button>
      </form>
    </section>
