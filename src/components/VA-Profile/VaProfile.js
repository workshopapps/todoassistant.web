    ...
    <div className="App">
              ...
              <div className={style.major_container}>      
                    ...
                    <div className={style.edit_container}>
                        ...
                        <div><button className={style.edit_button}>Edit Profile</button></div>
                    </div>  
                    
                     <div className={style.profile_container}>
                         <img src={mainProfileImage} alt="" className={style.main_profile_image}/>
                         
                         <div className={style.profile_container_items}>
                              <div className={style.profile_container_details1}>
                                  <p className={style.profile_container_items_header}>Sandra Davids</p>
                              ...
                              <div className={style.profile_container_details2}>
                                  ...
                                  <p className={style.profile_container__virtualA}>Virtual Assistant</p>
                              </div>
                              
                              <div className={style.profile_container_details3}>
                                  <p className={style.profile_container_items_paragraph}>Bio</p>
                                  <p className={style.profile_container_bio}>I am available 24 hours a day. You just sit back and count on me.</p>
                              </div> 
                              ...
                              <div className={style.profile_container_details4}>
                                  <div>
                                   ...
                                   <div>
                                      <p className={style.profile_container_items_paragraph}>Email Address</p>
                                      <p className={style.profile_container_items_header}>sandradavid@ticked.com</p>
                                  </div>
                              </div>  
                              
                               <div className={style.profile_container_details5}>
                                  <div>
                                      <p className={style.profile_container_items_paragraph}>Address</p>
                                      <p className={style.profile_container_address}>25 Adebanjo Street</p>
                                  </div>
                                  ...
                                  <div>
                                      <p className={style.profile_container_items_paragraph}>Country</p>
                               ...
                               <div className={style.profile_stats_container}>
                                   ...
                                   <div className={style.profile_stats_items_container}>
                                        <div className={style.profile_stats_items}>
                                            ...
                                            <p className={style.profile_stats_items_paragraph1}>Completed Task</p>
                                        </div>
                                        
                                         <div className={style.profile_stats_items}>
                                            <p className={style.profile_stats_items_header2}>5</p>
                                            <p className={style.profile_stats_items_paragraph2}>Assigned Client(s)</p>
                                        </div>
                                        
                                         <div className={style.profile_stats_items}>
                                            <p className={style.profile_stats_items_header3}>1</p>
                                            <p className={style.profile_stats_items_paragraph3}>Unassigned Client(s)</p>
                                        </div>
                                   </div>
                               </div>
                         </div>
