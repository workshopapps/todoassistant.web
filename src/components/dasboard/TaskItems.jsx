              ...
              >
                ...
                {i.va_option === "assign task" ? (
                  <div
                    ...
                    style={{ opacity: status === "EXPIRED" ? "0%" : "100%" }}
                  >
                    <svg
                      width="21"
                      height="20"
                    ...
                    >
                      <path
                        ...
                        stroke={status === "DONE" ? "#D3D0D9" : color.color}
                      />
                      <path
                    ...
                    <p style={{ color: status === "DONE" ? "" : color.color }}>
                      Assigned
                    </p>
                  </div>
                ) : (
                  ...
                  >
                    ...
                    >
                      ...
                      <path
                        ...
                        stroke="#714DD9"
                      />
                      <path d="M16.3544 14.9832H13.8711" stroke="#714DD9" />
                      <path d="M15.1133 13.7666V16.2583" stroke="#714DD9" />
                    </svg>
