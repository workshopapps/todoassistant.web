  ...
  return (
    <div className={styles.main}>
      <section className={styles.container}>
        <div className={styles.main__tick}>
          <div className={styles.main__tick__tickSub}>
            <img src={`https://res.cloudinary.com/kingsleysolomon/image/upload/v1668735681/hng/todoAppVirtualAssistant/Frame_34483_msotkx.svg`} alt="ticked" />
          </div>
      ...
      <div className={styles.main__phone}>
        <Animate.FadeIn>
          <img src={`https://res.cloudinary.com/kingsleysolomon/image/upload/v1668950997/hng/todoAppVirtualAssistant/Frame_34504_lgnz7c.svg`} alt="phone" />
        </Animate.FadeIn>
      </div>
    </div>
  );
