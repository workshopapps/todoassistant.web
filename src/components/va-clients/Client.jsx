    ...
    <div className={clientStyles.page}>
      <div className={clientStyles.side}>
        ...
        <div className={clientStyles.chatList}>
          { [{ name: 'Victor E.', message: 'This is a message. This...', timestamp: "6:00am" }, 
          { name: "Daniel Esther", message: "I booked an appointment...", timestamp: "6:00am", unreadCount: 2 }, 
          { name: "Sandra Davids", message: "How are you doing Alisa?...", timestamp: "7:03am", recipientHasRead: true }, 
          { name: "Seyi Daniels", message: "You need to improve on...", timestamp: '6:44am', recipientHasRead: false }, 
          { name: "John Andrew", message: "Kudo Andrew! You're doing...", timestamp: '6:20am', recipientHasRead: false }, 
          { name: "Victoria Phillips", message: "You missed your task today...", timestamp: '6:00am', recipientHasRead: false }].map(({name, message, timestamp, recipientHasRead}) => (
            <div className={clientStyles.listItem}>
              <div>
                <p className={clientStyles.chatListName}>{name}</p>
                <p>{recipientHasRead === true ? <ReadCheckIcon className={clientStyles.checkIcon} /> : recipientHasRead == undefined ? null : <DeliveredCheckIcon className={clientStyles.checkIcon} />}{message}</p>
              </div>
              <div>
