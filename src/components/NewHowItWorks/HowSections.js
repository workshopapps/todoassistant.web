...
import HowModal from "../../components/NewHowItWorks/HowModal";
    ...
    <div>
      <div className={style.how_container}>
        ...
        <div className={style.header_container}>
          <h1 className={style.how_header}>
            How It <span className={style.orange}>Works?</span>
          </h1>
        ...
        <div className={style.step_container1}>
          <div className={style.stepleft_container1}>
            ...
            <p className={style.steps_paragraph2}>
              Login, describe your task, and set the date and time for your task
              deadline.
            </p>
          </div>
        ...
        <div className={style.stepright_container2_background}>
          <div
            data-aos="fade-right"
            data-aos-duration="1500"
            className={style.step_container2}
          >
            ...
            <div className={style.stepleft_container2}>
              ...
              <p className={style.steps_paragraph12}>
                Personalise Virtual assitance
              </p>
              <p className={style.steps_paragraph22}>
                The in-app chat feature available allows you to communicate and
                assign tasks to a personalized Assitant.
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          data-aos="fade-left"
          data-aos-duration="1500"
          className={style.step_container3}
        >
          <div className={style.stepleft_container3}>
            ...
            <p className={style.steps_paragraph23}>
              Receive notifications when you complete your tasks and a call
              reminder when dealines are fast approaching.
            </p>
          </div>
