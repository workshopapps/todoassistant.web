...
import Map from "../Components/Contact_map/Map";
const CheckIcon = () => (
  <svg
    width="15"
    height="15"
    ...
    <section className={contactStyles.formSection}>
      <div className={contactStyles.top}>
        ...
        <p className={contactStyles.firstPara}>
          Our lovely team will love to hear from you, we will respond within 12
          hours
        </p>
        <p>
      ...
      <form>
        <div className={contactStyles.inputRow}>
          <label>
            Your full name <input type="text" placeholder="Gabriel Mark" />
          </label>
          <label>
            Email <input type="text" placeholder="gabrielmark@gmail.com" />
          </label>
          <label>
            Phone number <input type="text" placeholder="(219) 888-0124" />
          </label>
        </div>
        <label>
          Your message{" "}
          <textarea placeholder="Hi, I love your product so much, it really helped me stop procrastinating"></textarea>
        </label>
