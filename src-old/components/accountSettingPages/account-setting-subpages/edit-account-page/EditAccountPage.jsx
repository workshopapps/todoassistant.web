                        ...
                        <div className="single_input">
                            <label>Full Name
                                <input 
                                    ...
                                    className={errors.fullName && touched.fullName ? "input_error" : "" }
                        ...
                        <div className="single_input">
                            <label>Phone Number
                                <input 
                                    ...
                                    onBlur={handleBlur}
                                    onChange={handleChange}
                                    className={errors.phoneNumber && touched.phoneNumber ? "input_error" : "" }
                        ...
                        <div className="single_input">
                            <label>Confirm Password
                                <input 
                                    ...
                                    onBlur={handleBlur}
                                    onChange={handleChange}
                                    className={errors.password2 && touched.password2 ? "input_error" : "" } 
                                    name="password2"
                                    placeholder='Password' 
                                    required
                                />
